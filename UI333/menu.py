...
def openfile():
    ...
    cmd2 = filename
    cmd3 = ' -o /Users/nien/Desktop/milsss/test/test-file.png'
...
def openSample():
    ### open XML with the MuseScore and save the file named : test-file.png
    cmd = 'sudo /Applications/MuseScore\ 2.app/Contents/MacOS/mscore /Users/nien/Desktop/milsss/test/two-hand-2.xml -o /Users/nien/Desktop/milsss/test/test-file.png'
    os.system(cmd)
    ...
    ### turn the xml to wav
    cmd = 'sudo /Applications/MuseScore\ 2.app/Contents/MacOS/mscore /Users/nien/Desktop/milsss/test/two-hand-2.xml -o /Users/nien/Desktop/test/UI/wav.wav'
    os.system(cmd)
